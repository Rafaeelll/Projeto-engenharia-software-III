...
module.exports = {
  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addConstraint('agenda_jogos', {
      fields: ['agenda_id'], // Campo(s) da tabela de origem
      type: 'foreign key',
      name: 'agenda_jg_int_agendas_fk', // Nome da chave estrangeira (deve ser único do BD)
      references:{
    ...
    await queryInterface.addConstraint('agenda_jogos', {
      ...
      type: 'foreign key',
      name: 'agenda_jg_int_jogos_fk', // Nome da chave estrangeira (deve ser único do BD)
      references:{
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.removeConstraint('agenda_jogos', 'agenda_jg_int_jogos_fk');
    // Remove a restrição de chave estrangeira para o campo 'usuario_id'
    await queryInterface.removeConstraint('agenda_jogos', 'agenda_jg_int_agendas_fk');
  }
};
